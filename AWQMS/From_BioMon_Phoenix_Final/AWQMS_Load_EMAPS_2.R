...
d_count <- counts %>% 
  ...
  filter(Project %in% c('BPA Reference Site Survey','Coast Range Sub-Ecoregion','Salmonberry Flood Study')) %>%
...
write.csv(d,"//deqlab1/BioMon/Databases/RawData_to_AWQMS/EMAPS_2.csv",na = "",row.names = FALSE) 
