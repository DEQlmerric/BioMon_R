...
d_count <- counts %>% 
  ...
  filter(Project %in% c('Crooked TMDL','Trout Creek TMDL',
                          'Malheur TMDL','Mid Coast Bugs',
                          'South Coast TMDL','Tillamook RBS','RBS','15Mile Sediment')) %>%
...
write.csv(d,"//deqlab1/BioMon/Databases/RawData_to_AWQMS/TMDL.csv",na = "",row.names = FALSE) 
